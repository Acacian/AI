...
class Agent:
    def __init__(self, config_path: str):
        ...
        print(f"🚀 NoiseFilter initialized with topic: {self.topic}")
    ...
    def run(self):
        ...
        print(f"📡 Listening on Kafka topic: {self.topic}")
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("❌ 사용법: python -m agents_basket.noise_filter.agent <config_path> [offline]")
        sys.exit(1)
